 ...
 * @author thishantj
 */
public class nastaff_delete extends javax.swing.JFrame {

    /**
     * Creates new form searchStudent
     */
    public nastaff_delete() {
        initComponents();
    }
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        String sql1 = "delete from employee where EID = '"+"NA"+staffID.getText()+"'";
        String sql2 = "delete from non_academic_staff where EID = '"+"NA"+staffID.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nastaff_delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nastaff_delete().setVisible(true);
            }
        });
