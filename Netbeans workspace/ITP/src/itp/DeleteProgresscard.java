 ...
 * @author Lidushan
 */
public class DeleteProgresscard extends javax.swing.JFrame {

    /**
     * Creates new form Delete
     */
    public DeleteProgresscard() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            if(jStudentId.getText().trim().isEmpty()){JOptionPane.showMessageDialog(null, "Enter a student ID");}
            else{
            String query; 
            ...
            String query1; 
            query1 = "delete from progressCard where st_id = ? AND class = ? AND term=? ";
                        
            PreparedStatement pst1 = con.prepareStatement(query1);
            
            pst1.setString(1, jStudentId.getText());
            pst1.setString(2, class_select.getSelectedItem().toString());
            pst1.setString(3, term_select.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteProgresscard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
