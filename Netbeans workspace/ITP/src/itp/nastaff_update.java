 ...
 * @author thishantj
 */
public class nastaff_update extends javax.swing.JFrame {

    /**
     * Creates new form searchStudent
     */
    public nastaff_update() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(experience, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 520, 310, 50));
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        try {
            ...
            if(rs2.next() )
            {
                experience.setText(rs2.getString("experience"));
            }
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        String sql1 = "update employee set Name=?, DOB=?, sex=?, Marital_Status=?, Address=?, Tel=?, Email=?, Profession=? where EID = '"+"NA"+staffID.getText()+"'";

        String sql2 = "update non_academic_staff set experience=? where EID = '"+"NA"+staffID.getText()+"'";
        ...
        try {
            ...
            pst2.setString(1, experience.getText() );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nastaff_update.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nastaff_update().setVisible(true);
            }
        });
